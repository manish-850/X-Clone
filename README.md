...
- `Frontend/src/App.jsx` bootstraps the React app
- `Frontend/src/AppRoutes.jsx` defines public and protected routes
- `Frontend/src/Features/Auth/Login.jsx` and `Register.jsx` handle authentication
- `Frontend/src/Context/UserContext.jsx` loads user profile data
- `Frontend/src/Context/LoadingContext.jsx` manages loading state
